!(function (e) {
  function t(t) {
    for (
      var n, a, l = t[0], i = t[1], p = t[2], c = 0, s = [];
      c < l.length;
      c++
    )
      (a = l[c]),
  ...
  (a.m = e),
    ...
    (a.p = "/Random-Figma-Layout-1/");
  var l = (this.webpackJsonpantdapollo = this.webpackJsonpantdapollo || []),
    i = l.push.bind(l);
  (l.push = t), (l = l.slice());
...
//# sourceMappingURL=runtime-main.7322a7ef.js.map
